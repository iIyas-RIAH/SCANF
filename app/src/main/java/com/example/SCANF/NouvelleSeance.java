...
public class NouvelleSeance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nouvelle_seance);
        professeur = SharedPrefManager.getInstance(this).getProfesseur();
        btnEnregistrer = findViewById(R.id.btnEnregistrer);

        spinner = (Spinner) findViewById(R.id.spinnerClasse);
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, URLs.URL_LIST_CLASSES, null,
                    ...
                    public void onResponse(JSONObject response) {
                        try{
                            ...
                            for(int i=0;i<jsonArray.length();i++){
                                ...
                                classes.add(libelle);
                                classeAdapter = new ArrayAdapter<>(NouvelleSeance.this, R.layout.spinner_item, classes);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(NouvelleSeance.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        initDatePicker();
        dateSeance.setText(getTodayDate());
        SimpleDateFormat dateFormat = new SimpleDateFormat("HH:mm");
        timeSeance.setText(dateFormat.format(date));
    ...
    private void insertData() {
        ...
        if(classe.isEmpty()){
            ...
            progressDialog.show();
            StringRequest request = new StringRequest(Request.Method.POST, URLs.URL_NEW_SEANCES,
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(NouvelleSeance.this);
            requestQueue.add(request);
        }
    }
